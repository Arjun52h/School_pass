...
`school-pickup-pass` problem statement. It was created from the official
...
- **Challenge ID:** `school-pickup-pass`
- **Contributor:** Arjun Gautam
- **Live demo:** Add URL
...
```bash
npm run setup -- --challenge=school-pickup-pass --name="Your Name" --title="Your Project" --repo=https://github.com/you/project
npm run check
```

Replace `school-pickup-pass` with the ID shown in the selected problem statement.
Setup removes
